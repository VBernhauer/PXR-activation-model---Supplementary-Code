...
%%% note: adjust nprocs parameter (line 20) to the number of cores one
%%% wants to use
...
if ~exist('./chains_1OHMid3', 'dir')
    mkdir('./chains_1OHMid3')
end

%%% load initial parameters
parameters = load('paramsample_1OHMid3.mat');
...
for iproc = 1:nprocs
    ...
    task{iproc} = createTask(j, @mcmc_1OHMid3, 1, {nstart(iproc),nend(iproc),parameters});
    fprintf('done!\n');
end
